...
class UserAdapter : PagingDataAdapter<DataItem, UserAdapter.ViewHolder>(callback) {
    ...
    class ViewHolder(private val binding : ListItemUserBinding) :RecyclerView.ViewHolder(binding.root){
        fun bind (item : DataItem){
            ...
            itemView.setOnClickListener {
                val action = ThirdScreenFragmentDirections.actionThirdScreenFragmentToSecondScreenFragment(fullname,"FragmentThird")
